...
function Login() {
    ...
    const [email, setEmail] = useState('');        //tracking for email
    const [password, setPassword] = useState('');  //tracking for password

    const signIn = e => {
        e.preventDefault();       //Prevents browser from refreshing // e stands for an event.

        //Some fire base stuff
    ...
    return (
        ...
        <div className='login'>
            ...
            <div className='login__container'>
                ...
                <button onClick={register} className='login__registerButton'>Create your Amazing Account</button>
...
/* For login setup 
1. Go to firebase project and then go to "authentication" section and "enable email".
2. In terminal type "npm i firebase"
*/